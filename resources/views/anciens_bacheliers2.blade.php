                    ...
                    <form method="post" action="/anciens_bacheliers/inscription" id="formulaireab" class="register-form"
                        ...
                        <div class="fichiers">
                            ...
                            <div class="row col2" id="trimestre">
                                <div class="form-group">
                                    <label for="releveDeNoteDuBac" class="label">Relevé de note du bac<span
                                            class="ast">*</span></label>
                                    <input type="file" name="releveDeNoteDuBac" id="releveDeNoteDuBac"
                                        accept="image/*, application/pdf">
                                </div>
                                <div class="form-group">
                                    <label for="autreDocument" class="label">Autre document<span
                                            class="ast">*</span></label>
                                    <input type="file" name="autreDocument" id="autreDocument"
                                        accept="image/*, application/pdf">
                                </div>
                            </div>
                        </div>
